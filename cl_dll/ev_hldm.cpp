...
void EV_FireGlock1(event_args_t* args)
{
	...
	gEngfuncs.pEventAPI->EV_PlaySound(idx, origin, CHAN_AUTO, "weapons/pl_gun3.wav", gEngfuncs.pfnRandomFloat(0.92, 1.0), ATTN_NORM, 0, 98 + gEngfuncs.pfnRandomLong(0, 3));
...
void EV_FireOLR(event_args_t* args)
{
	...
	{
	case 0:
		gEngfuncs.pEventAPI->EV_PlaySound(idx, origin, CHAN_WEAPON, "weapons/olr1.wav", 1, ATTN_NORM, 0, 94 + gEngfuncs.pfnRandomLong(0, 0xf));
		break;
	case 1:
		gEngfuncs.pEventAPI->EV_PlaySound(idx, origin, CHAN_WEAPON, "weapons/olr2.wav", 1, ATTN_NORM, 0, 94 + gEngfuncs.pfnRandomLong(0, 0xf));
		break;
	}
...
void EV_FireCarbine(event_args_t* args)
{
	...
	if (EV_IsLocal(idx))
	{
		// Add muzzle flash to current weapon model
		EV_MuzzleFlashCov();
		gEngfuncs.pEventAPI->EV_WeaponAnimation(CARBINE_FIRE1 + gEngfuncs.pfnRandomLong(0, 2), 0);
	...
	{
	case 0:
		gEngfuncs.pEventAPI->EV_PlaySound(idx, origin, CHAN_WEAPON, "weapons/carbine_fire1.wav", 1, ATTN_NORM, 0, 94 + gEngfuncs.pfnRandomLong(0, 0xf));
		break;
	case 1:
		gEngfuncs.pEventAPI->EV_PlaySound(idx, origin, CHAN_WEAPON, "weapons/carbine_fire2.wav", 1, ATTN_NORM, 0, 94 + gEngfuncs.pfnRandomLong(0, 0xf));
		break;
	}
	...
	EV_HLDM_FireBullets(idx, forward, right, up, 1, vecSrc, vecAiming, 8192, BULLET_PLAYER_CARBINE, 2, &tracerCount[idx - 1], args->fparam1, args->fparam2);
}
//======================
//		 CARBINE END
//======================
...
void EV_HornetGunFire(event_args_t* args)
{
	...
	if (EV_IsLocal(idx))
	{
		...
		gEngfuncs.pEventAPI->EV_WeaponAnimation(HGUN_SHOOT_EMPTY, 0);
	}

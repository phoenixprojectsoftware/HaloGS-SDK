...
void CMP5::PrimaryAttack()
{
	...
	m_flTimeWeaponIdle = UTIL_WeaponTimeBase() + UTIL_SharedRandomFloat(m_pPlayer->random_seed, 15, 15);
}
...
void CMP5::Reload()
{
	...
	DefaultReload(MP5_MAX_CLIP, MP5_RELOAD, 2.7);
}
...
void CMP5::WeaponIdle()
{
	...
	case 0:
		iAnim = MP5_LONGIDLE;
		m_flTimeWeaponIdle = UTIL_WeaponTimeBase() + 81.0 / 8.0;
		break;

	default:
	case 1:
		iAnim = MP5_IDLE1;
		m_flTimeWeaponIdle = UTIL_WeaponTimeBase() + 81.0 / 35.0;
		break;
	}

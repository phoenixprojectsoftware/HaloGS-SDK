...
void CHalfLifeMultiplay::RefreshSkillData()
{
	...
	// Crowbar whack
	gSkillData.plrDmgCrowbar = 105;

	// Glock Round
	gSkillData.plrDmg9MM = 8;

	// 357 Round
	gSkillData.plrDmg357 = 22;

	// MP5 Round
	gSkillData.plrDmgMP5 = 9;

		// Carbine Round
	gSkillData.plrDmgCarbine = 22;

	// M203 grenade
	gSkillData.plrDmgM203Grenade = 65;

	// Shotgun buckshot
	gSkillData.plrDmgBuckshot = 12; // fewer pellets in deathmatch
	...
	// Hand Grendade
	gSkillData.plrDmgHandGrenade = 75;
...
void CHalfLifeMultiplay::PlayerSpawn(CBasePlayer* pPlayer)
{
	...
	if (addDefault)
	{
		...
		pPlayer->GiveAmmo(180, "9mm", _9MM_MAX_CARRY); // 4 full reloads
		pPlayer->GiveAmmo(36, "357", _357_MAX_CARRY); // 3 full reloads

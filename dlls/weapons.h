...
#define _9MM_MAX_CARRY 600
#define _357_MAX_CARRY 200
#define BUCKSHOT_MAX_CARRY 60
#define BOLT_MAX_CARRY 24
#define ROCKET_MAX_CARRY 2
...
#define VECTOR_CONE_12DEGREES Vector(0.11308, 0.11308, 0.11308)
...
class CM7 : public CBasePlayerWeapon
{
public:
	void Spawn() override;
	void Precache() override;
...
class CCarbine : public CBasePlayerWeapon
{
public:
	void Spawn() override;
	void Precache() override;
